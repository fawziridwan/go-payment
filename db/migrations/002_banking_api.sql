-- Banking Transaction API - Full Schema Migration
-- This migration creates the new schema as per the TSD specification

-- ============================================
-- 1. accounts table (new schema with UUID PK)
-- ============================================
